    ...
    @endif
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <select name="id_centro_custo" id="id_centro_custo" required class="form-control">
                    <option value="">Selecione</option>
                    <optgroup label="Saídas">
                        @foreach ($saidas->get() as $centroCusto)
                            <option value="{{ $centroCusto->id_centro_custo}}"
                            {{ $lancamento && $lancamento->id_centro_custo ==  $centroCusto->id_centro_custo 
                                ? 
                                'selected' 
                                :
                                '' 
            ...
            <div class="form-group col-md-2">
                ...
                <input type="date" name="dt_faturamento" id="dt_faturamento" class="form-control" 
                            value="{{$lancamento ? $lancamento->dt_faturamento : old('dt_faturamento')}}" required>
            </div>
            <div class="form-group col-md-2">
            ...
            <div class="form-group col-md-12">
               ...
               > {{$lancamento ? $lancamento->descricao : old('descricao')}}</textarea>
            </div>
            <div class="form-group col-md-2" id="form-tipo" >
                <input type="submit" value=" {{$lancamento ? 'Atualizar' : 'Cadastrar' }}" class="btn btn-primary">
            </div>
        </div>
    </form>
